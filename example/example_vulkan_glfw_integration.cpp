...
NVGcontext* vg[MAX_FRAMES_IN_FLIGHT];
DemoData data[MAX_FRAMES_IN_FLIGHT];
PerfGraph fps[MAX_FRAMES_IN_FLIGHT];
...
// ----------- nanovg Vulkan related functions
        for(int i=0;i<MAX_FRAMES_IN_FLIGHT;i++)
          init_nanovg_vulkan(commandBuffers[i], &vg[i], &fps[i], &data[i]);
// -----end of nanovg Vulkan related functions
    }
...
// ----------- nanovg Vulkan related functions
        ...
        nvgBeginFrame(vg[currentFrame], (float)winWidth, (float)winHeight, pxRatio);
        renderDemo(vg[currentFrame], (float)mx, (float)my, (float)winWidth, (float)winHeight, (float)t, (int)(blowup), &data[currentFrame]);
        renderGraph(vg[currentFrame], 5, 5, &fps[currentFrame]);

        nvgEndFrame(vg[currentFrame]);
